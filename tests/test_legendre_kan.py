"""Tests for LegendreKANLayer + LegendreKAN."""
...
from foundax.architectures.kan import LegendreKANLayer, LegendreBasis
...
LAYER = lambda i, o, **kw: LegendreKANLayer(i, o, degree=5, key=kw["key"])
